...
$query = "SELECT ID, NASDAQ_Symbol, Period, COUNT(*) c FROM NASDAQ_All_Companies_IS GROUP BY NASDAQ_Symbol, Period HAVING c > 1";
...
while ($row = mysql_fetch_assoc($result)) {
	...
	$query2 = "DELETE FROM NASDAQ_All_Companies_IS WHERE ID = " . $row['ID'];
