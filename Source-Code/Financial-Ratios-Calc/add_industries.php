...
$query = "SELECT NASDAQ_Symbol, Industry_Name FROM NASDAQ_All_Companies";
...
while ($row = mysql_fetch_assoc($result)) {
	...
	$query2 = "UPDATE NASDAQ_All_Companies_FR SET Industry='".$row['Industry_Name']."' WHERE NASDAQ_Symbol = '" . $row['NASDAQ_Symbol'] ."'";
