 ...
 * 4 columns
 */
$sql1 = "INSERT INTO NASDAQ_All_Companies_BS (	
								Company_ID,
								NASDAQ_Symbol,
								Period,
...
$sql2 = "INSERT INTO NASDAQ_All_Companies_BS (	
								Company_ID,
								NASDAQ_Symbol,
								Period,
								Cash_and_Cash_Equivalents,	
...
$sql3 = "INSERT INTO NASDAQ_All_Companies_BS (	
								Company_ID,
								NASDAQ_Symbol,
								Period,
								Cash_and_Cash_Equivalents,	
...
$sql4 = "INSERT INTO NASDAQ_All_Companies_BS (	
								Company_ID,
								NASDAQ_Symbol,
								Period,
								Cash_and_Cash_Equivalents,	
...
VALUES (
    ...
    if (!$result1) {
    	...
    	echo " - No data available. ArrayCounter: " . $arrayCounter;
    	if ($reconnected)
    		echo " Reconnect necessary.";
    }
